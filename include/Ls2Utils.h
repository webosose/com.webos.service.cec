...
inline void respondWithError(LS::Message &message, CecErrorCode errorCode, bool failedSubscription = false)
{
	respondWithError(message, retrieveErrorText(errorCode), errorCode, failedSubscription);
}

inline void respondWithError(LSMessage *message, CecErrorCode errorCode, bool failedSubscription = false)
{
	LS::Message msg(message);
	respondWithError(msg, retrieveErrorText(errorCode), errorCode, failedSubscription);
}

inline void respondWithError(LSMessage *message, const std::string& errorText, CecErrorCode errorCode, bool failedSubscription = false)
{
        LS::Message msg(message);
